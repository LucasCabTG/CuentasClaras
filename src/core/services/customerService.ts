...
export const addCustomer = async (customerData: Omit<Customer, 'id'>, userEmail: string) => {
...
export const updateCustomer = async (customerId: string, customerData: Partial<Customer>, userEmail: string, businessId: string) => {
...
export const deleteCustomer = async (customerId: string, userEmail: string, businessId: string) => {
  const customerRef = doc(db, 'customers', customerId);
